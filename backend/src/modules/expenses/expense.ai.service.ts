...
- note: if a quantity is mentioned (e.g. "for 2", "×3"), write it as "[quantity] [item]" — quantity first, then item (e.g. "for 2 eggs" → "2 Eggs", "chocos for 2" → "2 Chocos"). Do NOT recalculate or multiply prices — the stated amount is always the total. CRITICAL: Never mention cashback or reward amounts in this field. All cashback information must only be placed in the dedicated 'cashback' field.
