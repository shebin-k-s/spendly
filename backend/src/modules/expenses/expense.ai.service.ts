...
- description stays a short at-a-glance label (max 40 chars) naming the major item(s), never quantities/prices; multiple items are comma-separated (e.g. "Food, Drink"), never run together without a space (never "Food,Drink").
